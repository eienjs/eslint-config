...
import { type Awaitable, type TypedFlatConfigItem } from "./types"
 ...
 * @example
 * ```ts
 * import { renameRules } from '@eienjs/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@eienjs/eslint-config'
